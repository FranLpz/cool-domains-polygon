...
contract Domains is ERC721URIStorage {
  ...
  function register(string calldata name) public payable {
    ...
    // Check it enough Matic was paid in the transaction
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the Wallet name service", "image": "data:image/svg+xml;base64,',
    ...
    // Set the NFT data -- in this case the json blob 2/ our domain's info!
